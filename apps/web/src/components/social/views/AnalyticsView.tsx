    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={metric.title} className="bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md p-5 rounded-xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <p className="text-3xl font-bold text-slate-900 dark:text-slate-100">{metric.val}</p>
      ...
      <div className="bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md rounded-xl border border-slate-200 dark:border-zinc-800 shadow-sm p-12 flex flex-col items-center justify-center text-center">
        <div className="h-16 w-16 bg-slate-100 dark:bg-zinc-800 rounded-full flex items-center justify-center mb-4 text-slate-400">
          <BarChart3 className="h-8 w-8" />
        </div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Detailed Metrics Coming Soon</h2>
