  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Departments & Accounts</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {departments.map((dept) => (
          <div key={dept.id} className="bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md rounded-xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden flex flex-col">
            <div className="p-6 flex-1">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-1">{dept.name}</h3>
            ...
            <div className="px-6 py-4 border-t border-slate-100 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 flex gap-3">
              <button className="flex-1 px-3 py-1.5 bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md border border-slate-200 dark:border-zinc-800 hover:bg-slate-50 dark:bg-zinc-800/50 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-lg transition-colors">
                Manage
              </button>
              <button className="flex-1 px-3 py-1.5 bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md border border-slate-200 dark:border-zinc-800 hover:bg-slate-50 dark:bg-zinc-800/50 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-lg transition-colors">
                Settings
