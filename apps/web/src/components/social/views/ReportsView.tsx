  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Custom Reports</h1>
      ...
      <div className="bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md rounded-xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 flex gap-4">
          <button className="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md border border-slate-200 dark:border-zinc-800 rounded-md text-sm font-medium text-slate-700 dark:text-slate-300">
        ...
        <div className="divide-y divide-slate-100">
          {[
            ...
            <div key={i} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:bg-zinc-800/50 transition-colors">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center">
                  <FileText className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">{report.name}</h4>
