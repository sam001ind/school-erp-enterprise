  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex items-center gap-4">
      ...
      <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-slate-200 dark:border-zinc-800 shadow-sm rounded-3xl overflow-hidden">
        <div className="p-6 border-b border-slate-200 dark:border-zinc-800 flex justify-between items-center bg-slate-50 dark:bg-zinc-800/30">
          ...
          <select className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 text-sm rounded-lg px-3 py-1.5 outline-none">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 text-slate-500 dark:text-slate-400 text-xs uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-zinc-800">
              <tr className="hover:bg-slate-50/50 dark:hover:bg-zinc-800/30 transition-colors">
                <td className="px-6 py-4 font-bold text-slate-900 dark:text-white">John Doe <span className="block text-xs font-normal text-slate-500">STU-1029</span></td>
                ...
                <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">Mathematics (60%)</td>
              ...
              <tr className="hover:bg-slate-50/50 dark:hover:bg-zinc-800/30 transition-colors">
                <td className="px-6 py-4 font-bold text-slate-900 dark:text-white">Jane Smith <span className="block text-xs font-normal text-slate-500">STU-1144</span></td>
                ...
                <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">Physics (65%)</td>
                <td className="px-6 py-4 text-right">
                   <button className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 text-sm font-semibold">Send Warning</button>
                </td>
              </tr>
