...
export default function PlaceholderView({ title, description }: { title: string, description: string }) {
  return (
    <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-slate-200 dark:border-zinc-800 rounded-3xl p-12 flex flex-col items-center justify-center text-center min-h-[500px] shadow-sm">
      ...
      <div className="bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 px-6 py-3 rounded-xl inline-flex items-center gap-3">
