        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="/site/home" target="_blank" rel="noopener noreferrer" className="bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 px-4 py-2 rounded-xl font-bold shadow-sm transition-colors flex items-center gap-2">
                <span>🌐</span> View
              </a>
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 border border-zinc-100 dark:border-zinc-800 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('home')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-5 bg-white dark:bg-zinc-900 flex justify-between items-center">
                <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('about')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-800 p-4 pl-12 space-y-3">
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Leadership Team</p>
                    <p className="text-xs text-gray-500">/about-leadership</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('about-leadership')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">History & Mission</p>
                    <p className="text-xs text-gray-500">/about-history</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('about-history')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-5 bg-white dark:bg-zinc-900 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-zinc-100 dark:bg-zinc-800 rounded-lg flex items-center justify-center text-lg">📚</div>
                  <div>
                    <p className="font-bold text-lg dark:text-white text-zinc-900">Academics</p>
                    <p className="text-sm text-gray-500 font-medium">/academics</p>
                  </div>
                </div>
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('academics')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-800 p-4 pl-12 space-y-3">
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Programs & Courses</p>
                    <p className="text-xs text-gray-500">/academics-programs</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('academics-programs')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Faculty</p>
                    <p className="text-xs text-gray-500">/academics-faculty</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('academics-faculty')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="p-5 bg-white dark:bg-zinc-900 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-medium">/admissions-info</p>
                  </div>
                </div>
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('admissions-info')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-800 p-4 pl-12 space-y-3">
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Fee Structure</p>
                    <p className="text-xs text-gray-500">/admissions-fees</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('admissions-fees')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Apply Now</p>
                    <p className="text-xs text-gray-500">/admissions-apply</p>
                  </div>
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('admissions-apply')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-5 bg-white dark:bg-zinc-900 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-zinc-100 dark:bg-zinc-800 rounded-lg flex items-center justify-center text-lg">⚽</div>
                  <div>
                    <p className="font-bold text-lg dark:text-white text-zinc-900">Campus Life</p>
                    <p className="text-sm text-gray-500 font-medium">/campus-life</p>
                  </div>
                </div>
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('campus-life')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-800 p-4 pl-12 space-y-3">
                <div className="flex justify-between items-center border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                  <div>
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">Events & News</p>
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() => handleEdit('campus-events')} className="text-zinc-600 dark:text-zinc-400 font-medium text-sm hover:underline">Edit</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 border border-zinc-100 dark:border-zinc-800 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-zinc-100 dark:bg-zinc-800 rounded-lg flex items-center justify-center text-lg">🤝</div>
                  <div>
                    <p className="font-bold text-lg dark:text-white text-zinc-900">Student Services</p>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <button onClick={() => handleEdit('student-services')} className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors ml-2">Edit Template</button>
                  <button className="text-zinc-400 hover:text-zinc-600 ml-2">⚙️</button>
                </div>
              </div>
            </div>
