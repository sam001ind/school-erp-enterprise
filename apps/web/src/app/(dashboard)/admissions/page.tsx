    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      {activeTab === "campaigns" && (
        <div className="animate-in fade-in duration-500 space-y-8">
           <header className="mb-8 flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Campaigns & Leads</h1>
              <p className="text-gray-500 mt-2">Manage marketing campaigns, track Meta/Web leads, and convert prospects.</p>
            </div>
            <div className="flex gap-3">
               <div className="bg-zinc-100 dark:bg-zinc-800 p-1 rounded-xl flex items-center mr-2">
                 <button onClick={() => setViewMode('kanban')} className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-colors ${viewMode === 'kanban' ? 'bg-white dark:bg-zinc-700 shadow-sm text-zinc-900 dark:text-white' : 'text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300'}`}>Kanban</button>
                 <button onClick={() => setViewMode('table')} className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-colors ${viewMode === 'table' ? 'bg-white dark:bg-zinc-700 shadow-sm text-zinc-900 dark:text-white' : 'text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300'}`}>Table</button>
               </div>
               <button 
                 onClick={() => setShowIntegrationModal(true)}
                 className="px-5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 font-medium bg-white dark:bg-zinc-900 shadow-sm"
               >
          ...
          <div className="flex gap-6 overflow-x-auto pb-4 min-h-[600px]">
             ...
             <div className="min-w-[320px] max-w-[320px] flex flex-col gap-4">
                ...
                {/* Lead Card 1 */}
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm cursor-grab hover:border-blue-300 transition-colors">
                   ...
                   <p className="text-sm text-zinc-500 mb-4">+1 (555) 019-2834</p>
                   <div className="flex gap-2">
                      ...
                      <button className="flex-1 py-1.5 border border-zinc-200 dark:border-zinc-700 rounded-lg text-xs font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                         Call
                      </button>
                   </div>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm cursor-grab hover:border-blue-300 transition-colors">
                   ...
                   <p className="text-sm text-zinc-500 mb-4">+1 (555) 832-1100</p>
                   <div className="flex gap-2">
             ...
             <div className="min-w-[320px] max-w-[320px] flex flex-col gap-4">
                ...
                {/* Lead Card 3 */}
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm cursor-grab hover:border-amber-300 transition-colors">
                   <div className="flex justify-between items-start mb-3">
                      <span className="text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 px-2 py-1 rounded-md">Meta Ads</span>
                   ...
                   <p className="text-sm text-zinc-500 mb-4">+1 (555) 443-9921</p>
                   <div className="flex gap-2">
             ...
             <div className="min-w-[320px] max-w-[320px] flex flex-col gap-4">
                <div className="flex items-center justify-between">
                 ...
                 {/* Lead Card 4 */}
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm cursor-grab hover:border-purple-300 transition-colors">
                   <div className="flex justify-between items-start mb-3">
                   ...
                   <p className="text-sm text-zinc-500 mb-4">+1 (555) 776-3342</p>
                   <div className="flex gap-2">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm overflow-hidden min-h-[600px]">
             <div className="p-4 border-b border-gray-100 dark:border-zinc-800 flex flex-col sm:flex-row gap-4 bg-zinc-50 dark:bg-zinc-950">
               <input type="text" placeholder="Search leads by name, phone, or email..." className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg px-4 py-2 text-sm" />
               <div className="flex gap-4">
                 <select className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg px-4 py-2 text-sm"><option>All Sources</option><option>Meta Ads</option><option>Website</option></select>
                 <select className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg px-4 py-2 text-sm"><option>All Stages</option><option>New Leads</option><option>Attempted Contact</option><option>In Conversation</option></select>
               </div>
             </div>
             <div className="overflow-x-auto">
               <table className="w-full text-left border-collapse min-w-[800px]">
                  <thead>
                    <tr className="bg-zinc-50 dark:bg-zinc-950 text-gray-500 text-sm border-b border-gray-100 dark:border-zinc-800">
                  ...
                  <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-sm">
                    <tr className="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                      ...
                      <td className="px-6 py-4 text-zinc-500">+1 (555) 019-2834</td>
                      ...
                      <td className="px-6 py-4 text-zinc-500">10m ago</td>
                      <td className="px-6 py-4 flex justify-end gap-2">
                         ...
                         <button className="px-3 py-1.5 border border-zinc-200 dark:border-zinc-700 rounded-lg text-xs font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-800">Call</button>
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                      <td className="px-6 py-4 font-bold dark:text-white">Michael Chen</td>
                      <td className="px-6 py-4 text-zinc-500">+1 (555) 832-1100</td>
                      ...
                      <td className="px-6 py-4"><span className="px-2 py-1 bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 rounded-lg text-xs font-semibold flex items-center w-max gap-1.5"><div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> New Lead</span></td>
                      <td className="px-6 py-4 text-zinc-500">1h ago</td>
                      <td className="px-6 py-4 flex justify-end gap-2">
                    ...
                    <tr className="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                      ...
                      <td className="px-6 py-4 text-zinc-500">+1 (555) 443-9921</td>
                      <td className="px-6 py-4"><span className="text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 px-2 py-1 rounded-md">Meta Ads</span></td>
                    ...
                    <tr className="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                      ...
                      <td className="px-6 py-4 text-zinc-500">+1 (555) 776-3342</td>
      ...
      {showIntegrationModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full max-w-2xl p-8 relative shadow-2xl animate-in zoom-in-95 duration-200">
             <button onClick={() => setShowIntegrationModal(false)} className="absolute top-6 right-6 text-zinc-400 hover:text-zinc-600">✕</button>
             <h2 className="text-2xl font-bold mb-2 dark:text-white">Integration Settings</h2>
             <p className="text-zinc-500 mb-6">Configure your Webhooks for Meta Lead Ads and Website Forms.</p>
             
             <div className="space-y-6">
                <div>
                  <label className="block text-sm font-bold mb-2 dark:text-white">Meta Webhook URL</label>
                  <div className="flex gap-2">
                     <input type="text" readOnly value="https://api.myinstitution.edu/api/webhooks/meta" className="flex-1 bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 font-mono text-sm dark:text-zinc-300" />
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                     <input type="text" readOnly value="https://api.myinstitution.edu/api/leads" className="flex-1 bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 font-mono text-sm dark:text-zinc-300" />
                     <button className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 dark:text-white rounded-xl font-medium text-sm">Copy</button>
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-bold mb-2 dark:text-white">API Secret Key</label>
                  <input type="password" readOnly value="************************" className="w-full bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 font-mono text-sm dark:text-zinc-300" />
                </div>
             </div>
      ...
      {showNewCampaignModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full max-w-xl p-8 relative shadow-2xl animate-in zoom-in-95 duration-200">
             <button onClick={() => setShowNewCampaignModal(false)} className="absolute top-6 right-6 text-zinc-400 hover:text-zinc-600">✕</button>
             <h2 className="text-2xl font-bold mb-2 dark:text-white">Create New Campaign</h2>
             <p className="text-zinc-500 mb-6">Set up tracking for a new marketing campaign.</p>
             
             <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold mb-1 dark:text-white">Campaign Name</label>
                  <input type="text" placeholder="e.g. Fall 2026 Admissions" className="w-full bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 dark:text-white" />
                </div>
                <div>
                  <label className="block text-sm font-bold mb-1 dark:text-white">Source Platform</label>
                  <select className="w-full bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 dark:text-white">
                ...
                <div>
                  ...
                  <input type="number" placeholder="$0.00" className="w-full bg-zinc-50 dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2 dark:text-white" />
                </div>
             </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-[#efeae2] dark:bg-zinc-900 rounded-3xl w-full max-w-md relative shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden flex flex-col h-[600px]">
             ...
             <div className="bg-[#075e54] text-white p-4 flex items-center gap-3 relative z-10 shadow-md">
                ...
                <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center font-bold text-lg">{whatsappContact.name.charAt(0)}</div>
                <div>
             ...
             <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-3 z-10" style={{backgroundImage: "url('https://raw.githubusercontent.com/tailwindlabs/tailwindcss/master/.github/logo.svg')", backgroundSize: 'cover', backgroundColor: '#efeae2', backgroundBlendMode: 'soft-light'}}>
                <div className="bg-white/80 dark:bg-black/50 backdrop-blur-sm p-2 rounded-lg self-center text-xs text-zinc-500 font-medium mb-2">Today</div>
                
                <div className="bg-white dark:bg-zinc-800 p-3 rounded-xl rounded-tl-sm self-start max-w-[80%] shadow-sm text-sm dark:text-white relative">
             ...
             <div className="bg-[#f0f2f5] dark:bg-zinc-900 p-3 flex items-center gap-2 relative z-10 border-t border-zinc-200 dark:border-zinc-800">
                <button className="text-zinc-500 hover:text-zinc-700 p-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><path d="M8 14s1.5 2 4 2 4-2 4-2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg></button>
                <input type="text" placeholder="Type a message (via Twilio API)" className="flex-1 bg-white dark:bg-zinc-800 rounded-full px-4 py-2 text-sm focus:outline-none dark:text-white" />
