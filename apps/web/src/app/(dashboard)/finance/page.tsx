...
import { CreditCard, Search, Filter, Plus, ArrowUpRight, ArrowDownRight, MoreVertical } from "lucide-react";
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">Track invoices, payments, and financial reports.</p>
        </div>
